...
public class ImpresorLCD {
   ...
   //Variable entera para el tamaño.
    private int size;
    ...
    private void imprimirNumero(int size, String numeroImp, int espacio) 
    {
        ...
        for (char digito : digitos) {
            ...
            {
                JOptionPane.showMessageDialog(null,"El valor ingresado no es un digito","Mensaje de Advertencia",JOptionPane.WARNING_MESSAGE); 
        ...
        //Se muestra dialogo de confirmacion al usuario.
        JOptionPane.showMessageDialog(null,"Impresiòn exitosa");
    }
    ...
    public void procesar(String comando, int espacioDig) {
        ...
        if (!comando.contains(",")) {
             ...
             //Se muestra dialogo de advertencia al usuario.
        JOptionPane.showMessageDialog(null,"No se ingreso ningun caracter valìdo","Mensaje de Advertencia",JOptionPane.WARNING_MESSAGE); 
        ...
        {
            JOptionPane.showMessageDialog(null,"Se supero el nùmero de caracteres","Mensaje de Advertencia",JOptionPane.WARNING_MESSAGE); 
           throw new IllegalArgumentException("Cadena " + comando
        ...
        if(parametros.length<2)
        {
            JOptionPane.showMessageDialog(null,"No contiene los parametros requeridos","Mensaje de Advertencia",JOptionPane.WARNING_MESSAGE); 
           throw new IllegalArgumentException("Cadena " + comando
        ...
        if(isNumeric(parametros[0]))
        {
            ...
            if(tam <1 || tam >10)
            {
                JOptionPane.showMessageDialog(null,"El valor size debe estar entre 1 y 10 ","Mensaje de Advertencia",JOptionPane.WARNING_MESSAGE); 
